...
public class Pedido extends Estoque{
	...
	//adicionei esse if, se tiver no estoque add o item, sen„o n„o add.
        ...
        return true;
        	...
        	System.out.println("Ultrapassa quantidade do estoque, n„o foi possivel adicionar o produto.");
        	return false;
        }
        }
